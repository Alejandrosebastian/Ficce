...
namespace FICCE.Controllers
{
    public class EventosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventoId,año,mes")] Evento evento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventoId,año,mes")] Evento evento)
        {
